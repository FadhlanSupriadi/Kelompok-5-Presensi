                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">Divisi</label>
                        <select name="id_div" class="form-control" required>
                          <?php foreach($divisi as $kat){
                            if(!in_array($kat['id_div'],$label_post)){
                              ?>
                              <option value="<?php echo $kat['id_div'] ?>"><?php echo $kat['divisi'] ?></option>
                              <?php } else { ?>
                              <option selected="selected" value="<?php echo $kat['id_div'] ?>"><?php echo $kat['divisi'] ?></option>
                              <?php } } ?>
                        </select> 
                    </div>
                    <div class="form-group">
